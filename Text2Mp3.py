...
def generatemedium(url):
    try:
        ...
        messagebox.showinfo("Medium Blog to MP3 " , " Failed. Please check URL or your internet connection. If everything is right at your end, send a mail to kumarabhinav184@gmail.com along with the article link;" );
